...
use app\modules\api\commands\telegram\callback\DayDetailCallback;
use app\modules\api\commands\telegram\callback\DayListCallback;
use app\modules\api\commands\telegram\callback\DayViewCallback;
use app\modules\api\commands\telegram\callback\DeclineCallback;
use app\modules\api\commands\telegram\callback\MenuCallback;
use app\modules\api\commands\telegram\callback\MyCallback;
use app\modules\api\commands\telegram\callback\MyCoworkersCallback;
use app\modules\api\commands\telegram\callback\OrderAcceptCallback;
use app\modules\api\commands\telegram\callback\OrderCallback;
use app\modules\api\commands\telegram\callback\OrderDetailCallback;
use app\modules\api\commands\telegram\callback\OrderListCallback;
use app\modules\api\commands\telegram\callback\OrderRejectCallback;
use app\modules\api\commands\telegram\callback\OrderViewCallback;
use app\modules\api\commands\telegram\callback\ReportStartCallback;
use app\modules\api\commands\telegram\callback\ReportStopCallback;
use app\modules\api\commands\telegram\callback\StartDayCallback;
use app\modules\api\commands\telegram\callback\StopDayCallback;
use app\modules\api\commands\telegram\Command;
use app\modules\api\commands\telegram\command\ClearCommand;
use app\modules\api\commands\telegram\command\DayListCommand;
use app\modules\api\commands\telegram\command\HelloCommand;
use app\modules\api\commands\telegram\command\MenuCommand;
use app\modules\api\commands\telegram\command\MyCommand;
use app\modules\api\commands\telegram\command\OrderListCommand;
use app\modules\api\commands\telegram\command\ShowDataCommand;
use app\modules\api\commands\telegram\command\StartCommand;
use app\modules\api\commands\telegram\command\StartDayCommand;
use app\modules\api\commands\telegram\command\StartReportCommand;
use app\modules\api\commands\telegram\command\StopReportCommand;
