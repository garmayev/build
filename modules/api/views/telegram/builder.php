...
<div class="container">
    ...
    <div class="editor-container">
        <div class="nodes-panel">
            <h3>Элементы</h3>
            <div class="node-type" data-type="start">Начало</div>
            <div class="node-type" data-type="message">Сообщение</div>
            <div class="node-type" data-type="question">Вопрос</div>
            <div class="node-type" data-type="end">Конец</div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Обработчики для перетаскивания нод
        document.addEventListener('mousemove', e => {
            ...
            // Обновляем соединения при перемещении ноды
            updateConnections();
        });
