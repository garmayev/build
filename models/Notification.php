...
class Notification extends ActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            ...
            [['status'], 'in', 'range' => [self::STATUS_NEW, self::STATUS_AGREE, self::STATUS_DISAGREE, self::STATUS_DELETED]],
    ...
    {
        return $this->hasOne(Coworker::className(), ['id' => 'coworker_id']);
    }

    public static function send($order_id, $ignoreList = [])
    {
